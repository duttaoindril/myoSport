...
var DTW = function (options) {
    ...
    if (typeof options === 'undefined') {
        state.distance = sqEuclidDistance;
    } else {
...
function computeOptimalPath(s, t, state) {
    console.log('> computeOptimalPath');
    ...
    var time = end - start;
    console.log('< computeOptimalPath (' + time + ' ms)');
...
function computeOptimalPathWithWindow(s, t, w, state) {
    console.log('> computeOptimalPathWithWindow');
    validateComputeParameters(s, t);
    var start = new Date().getTime();
    state.m = s.length;
    state.n = t.length;
    ...
    var end = new Date().getTime();
    var time = end - start;
    console.log('< computeOptimalPathWithWindow (' + time + ' ms)');
...
function retrieveOptimalPath(state) {
    console.log('> retrieveOptimalPath');
    var start = new Date().getTime();
    ...
    var end = new Date().getTime();
    var time = end - start;
    console.log('< retrieveOptimalPath (' + time + ' ms)');
    return path.reverse();
}